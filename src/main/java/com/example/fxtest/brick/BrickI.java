...
public class BrickI implements Brick{
    ...
    public BrickI(int center_x, int center_y, Color color, GameBoard1 gameBoard) {
        ...
        this.d=new Block(center_x,center_y-2,color);
        this.shape=0;
        blockList.add(a);
        blockList.add(b);
        blockList.add(c);
    ...
    public boolean canRotate() { // 0 > 1 > 2 > 3
        ...
        if (nextShape == 3) {
            ...
            Rotate_d = new Block(b.getX() + 2, b.getY());
            temp.add(Rotate_a);
            temp.add(Rotate_b);
            temp.add(Rotate_c);
            temp.add(Rotate_d);
