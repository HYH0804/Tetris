...
public class BrickO implements Brick{
    ...
    public BrickO(int center_x, int center_y, Color color, GameBoard1 gameBoard) {
        ...
        this.c=new Block(center_x+1, center_y-1,color);
