...
public class RandomGeneratorHardTest {
    ...
    public void testBlockDistribution() {
        ...
        int totalRuns = 1000;
        int difficulty = 2; // Test for easy mode
...
>>>>>>> bbe697f0f626ce69284da1bd18325a3529e425b5
        ...
        double expectedPercentage = 10.0 / 68.0; // For non-I blocks
        double expectedIPercentage = 8.0 / 68.0; // For I blocks
